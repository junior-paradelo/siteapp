...
INSERT INTO SITES (ID, CREATED_AT, ENABLED, NAME, PROVINCE, TOWN_HALL, DESCRIPTION, CATEGORY_ID) VALUES (nextval('site_id_seq'), now(), true, 1.0, 1.0, 'Sitio A', 'Provincia A', 'Ayuntamiento A', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent gravida arcu a tortor mattis venenatis. Nunc gravida varius est et faucibus. Sed ullamcorper vehicula dui.', 1);
INSERT INTO SITES (ID, CREATED_AT, ENABLED, NAME, PROVINCE, TOWN_HALL, DESCRIPTION, CATEGORY_ID) VALUES (nextval('site_id_seq'), now(), true, 1.0, 1.0, 'Sitio B', 'Provincia B', 'Ayuntamiento B', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent gravida arcu a tortor mattis venenatis. Nunc gravida varius est et faucibus. Sed ullamcorper vehicula dui.', 3);
INSERT INTO SITES (ID, CREATED_AT, ENABLED, NAME, PROVINCE, TOWN_HALL, DESCRIPTION, CATEGORY_ID) VALUES (nextval('site_id_seq'), now(), true, 1.0, 1.0, 'Sitio C', 'Provincia C', 'Ayuntamiento C', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent gravida arcu a tortor mattis venenatis. Nunc gravida varius est et faucibus. Sed ullamcorper vehicula dui.', 2);
INSERT INTO SITES (ID, CREATED_AT, ENABLED, NAME, PROVINCE, TOWN_HALL, DESCRIPTION, CATEGORY_ID) VALUES (nextval('site_id_seq'), now(), true, 1.0, 1.0, 'Sitio D', 'Provincia D', 'Ayuntamiento D', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent gravida arcu a tortor mattis venenatis. Nunc gravida varius est et faucibus. Sed ullamcorper vehicula dui.', 2);
INSERT INTO SITES (ID, CREATED_AT, ENABLED, NAME, PROVINCE, TOWN_HALL, DESCRIPTION, CATEGORY_ID) VALUES (nextval('site_id_seq'), now(), true, 1.0, 1.0, 'Sitio E', 'Provincia E', 'Ayuntamiento E', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent gravida arcu a tortor mattis venenatis. Nunc gravida varius est et faucibus. Sed ullamcorper vehicula dui.', 1);
